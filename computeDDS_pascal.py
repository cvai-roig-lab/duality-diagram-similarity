...
def get_features(taskonomy_feats_path,pascal_feats_path,features_filename):
    ...
    np.save("taskonomy_pascal_feats_pascal_5000.npy", taskonomy_data)
...
def main():
    ...
    parser.add_argument('-i','--num_iters', help='number of iterations for bootstrap', default = 2, type=int)
    ...
    features_filename = "taskonomy_pascal_feats_" + args['dataset'] + ".npy"
