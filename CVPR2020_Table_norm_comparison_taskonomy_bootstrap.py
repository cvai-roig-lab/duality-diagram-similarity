...
def main():
    ...
    feature_ablation_type = ['None','centering','znorm']#,'group_norm','instance_norm','layer_norm','batch_norm']#'z_norm_my_implementation']#'covLF',
    save_dir = './CVPR2020_results/bootstrap_normcomparison_' + dataset
