...
def main():
    ...
    num_images_range = range(10,510,20)
    ...
    feature_ablation_type = ['znorm']#'z_norm_my_implementation']#'covLF',
    save_dir = './CVPR2020_results/normcomparison_num_images_' + dataset
    ...
    for num_images in num_images_range:
        ...
        save_path = os.path.join(save_dir,str(num_images).zfill(3) + 'rdms.npy')
        dist_type = ['pearson', 'euclidean', 'cosine']
        affinity_ablation = {}
